...
public class MinHeap<T extends Comparable<T>> {
    ...
    /**
     * Returns the element at a specific index of the underlying dynamic array
    ...
    /**
    * Checks if the node at the specified index has a left child.
    * A node has a left child if the index 2i + 1 exists within the heap's size.
    * 
    * @param index the index of the node to check for a left child
    ...
    */
    ...
    /**
    * Checks if the node at the specified index has a right child.
    * A node has a right child if the index 2i + 2 exists within the heap's size.
    * 
    * @param index the index of the node to check for a right child
